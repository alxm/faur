...
F_SDK_ARDUINO_DIR_15 ?= $(HOME)/.arduino15
F_SDK_ARDUINO_DIR_INSTALL ?= /opt/arduino
F_SDK_ARDUINO_DIR_SKETCHBOOK ?= $(HOME)/Arduino
...
F_SDK_MINGW64_ROOT ?= /usr/x86_64-w64-mingw32

F_SDK_ODROID_GO_ESPTOOL ?= $(HOME)/.arduino15/packages/esp32/tools/esptool_py/3.0.0
F_SDK_ODROID_GO_HARDWARE_TOOLS ?= $(HOME)/.arduino15/packages/esp32/hardware/esp32/1.0.6/tools
