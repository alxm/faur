...
$(F_BUILD_FILES_EMBED_INIT) : $(F_BUILD_FILES_EMBED_TARGET) $(F_FAUR_DIR_BIN)/faur-embed-pop
	@ mkdir -p $(@D) $(F_BUILD_DIR_GEN_EMBED)
	$(F_FAUR_DIR_BIN)/faur-embed-pop $@ $(F_BUILD_DIR_GEN_EMBED) f__bin_ $(F_BUILD_FILES_EMBED_NAMES)
