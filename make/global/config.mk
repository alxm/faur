...
# Debug Output
#
F_CONFIG_OUTPUT_ENABLED ?= 1
F_CONFIG_CONSOLE_ENABLED ?= 1
F_CONFIG_CONSOLE_SHOW ?= 0

ifeq ($(F_CONFIG_OUTPUT_ENABLED), 0)
...
# Libraries
#
#   F_CONFIG_LIB_PNG - Build with PNG support
#   F_CONFIG_LIB_RENDER - Possible values: SOFTWARE, SDL
#   F_CONFIG_LIB_SDL - 1 or 2 if using SDL
#   F_CONFIG_LIB_SDL_CONFIG - Path to sdl-config host binary
#   F_CONFIG_LIB_SDL_GAMEPADMAP - Bin-relative path to SDL2 gamepad mappings
#   F_CONFIG_LIB_SDL_TIME - Whether to use the SDL timer
#
F_CONFIG_LIB_PNG ?= 0
F_CONFIG_LIB_SDL ?= 0
...
F_CONFIG_BUILD_CFLAGS += \
    ...
    -DF_CONFIG_OUTPUT_ENABLED=$(F_CONFIG_OUTPUT_ENABLED) \
    -DF_CONFIG_PATH_STORAGE_PREFIX=\"$(F_CONFIG_PATH_STORAGE_PREFIX)\" \
    -DF_CONFIG_SCREEN_ALLOCATE=$(F_CONFIG_SCREEN_ALLOCATE) \
    -DF_CONFIG_SCREEN_BPP=$(F_CONFIG_SCREEN_BPP) \
    ...
    -DF_CONFIG_SCREEN_ORDER_$(F_CONFIG_SCREEN_ORDER)=1 \
