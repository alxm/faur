...
A_CONFIG_BUILD_C_STANDARD ?= c99
A_CONFIG_BUILD_DEBUG ?= 0
A_CONFIG_BUILD_DEBUG_ALLOC ?= 0
A_CONFIG_BUILD_DEBUG_FATAL_SPIN ?= 0
A_CONFIG_BUILD_DEBUG_WAIT ?= 0
A_CONFIG_BUILD_FIX_LUT ?= 0
A_CONFIG_BUILD_FIX_LUT_GENERATE ?= 0
A_CONFIG_BUILD_ID ?= default
A_CONFIG_BUILD_LIBS ?=
A_CONFIG_BUILD_MAIN ?= 1
A_CONFIG_BUILD_OPT ?= 0
A_CONFIG_BUILD_PLATFORM ?= unknown
A_CONFIG_BUILD_UID := $(A_CONFIG_BUILD_PLATFORM)_$(A_CONFIG_BUILD_ID)
A_CONFIG_BUILD_SRC_EXTRA ?=

ifdef A_CONFIG_BUILD_SRC_EXTRA
    A_CONFIG_BUILD_SRC_EXTRA := $(realpath $(A_CONFIG_BUILD_SRC_EXTRA))
endif

ifneq ($(A_CONFIG_BUILD_DEBUG_ALLOC), 0)
    A_CONFIG_BUILD_DEBUG := 1
endif

ifneq ($(A_CONFIG_BUILD_DEBUG_WAIT), 0)
    A_CONFIG_BUILD_DEBUG := 1
endif
...
A_CONFIG_FPS_HISTORY ?= $(shell expr $(A_CONFIG_FPS_RATE_TICK) \* 2)
...
ifeq ($(shell expr $(A_CONFIG_FPS_HISTORY) \< 1), 1)
    $(error A_CONFIG_FPS_HISTORY ($(A_CONFIG_FPS_HISTORY)) < 1)
endif
...
# Debug Output
#
A_CONFIG_OUTPUT_ENABLED ?= 1
A_CONFIG_CONSOLE_ENABLED ?= 1
A_CONFIG_CONSOLE_SHOW ?= 0

ifeq ($(A_CONFIG_OUTPUT_ENABLED), 0)
    A_CONFIG_CONSOLE_ENABLED := 0
endif
...
#   A_CONFIG_SCREEN_SIZE_HEIGHT, WIDTH - Logical screen resolution
...
ifneq ($(A_CONFIG_SCREEN_HARDWARE_WIDTH), 0)
    A_CONFIG_SCREEN_SIZE_WIDTH ?= $(A_CONFIG_SCREEN_HARDWARE_WIDTH)
endif

ifneq ($(A_CONFIG_SCREEN_HARDWARE_HEIGHT), 0)
    A_CONFIG_SCREEN_SIZE_HEIGHT ?= $(A_CONFIG_SCREEN_HARDWARE_HEIGHT)
endif

A_CONFIG_SCREEN_SIZE_WIDTH ?= 320
A_CONFIG_SCREEN_SIZE_HEIGHT ?= 240
...
# Libraries
#
#   A_CONFIG_LIB_PNG - Build with PNG support
...
A_CONFIG_BUILD_CFLAGS += \
    ...
    -DA_CONFIG_BUILD_DEBUG_ALLOC=$(A_CONFIG_BUILD_DEBUG_ALLOC) \
    -DA_CONFIG_BUILD_DEBUG_FATAL_SPIN=$(A_CONFIG_BUILD_DEBUG_FATAL_SPIN) \
    -DA_CONFIG_BUILD_DEBUG_WAIT=$(A_CONFIG_BUILD_DEBUG_WAIT) \
    -DA_CONFIG_BUILD_FIX_LUT=$(A_CONFIG_BUILD_FIX_LUT) \
    -DA_CONFIG_BUILD_FIX_LUT_GENERATE=$(A_CONFIG_BUILD_FIX_LUT_GENERATE) \
    -DA_CONFIG_BUILD_MAIN=$(A_CONFIG_BUILD_MAIN) \
    ...
    -DA_CONFIG_CONSOLE_ENABLED=$(A_CONFIG_CONSOLE_ENABLED) \
    ...
    -DA_CONFIG_LIB_PNG=$(A_CONFIG_LIB_PNG) \
    ...
    -DA_CONFIG_OUTPUT_ENABLED=$(A_CONFIG_OUTPUT_ENABLED) \
    ...
    -DA_CONFIG_SCREEN_SIZE_HEIGHT=$(A_CONFIG_SCREEN_SIZE_HEIGHT) \
    -DA_CONFIG_SCREEN_SIZE_WIDTH=$(A_CONFIG_SCREEN_SIZE_WIDTH) \
    ...
    -DA_CONFIG_SYSTEM_GAMEBUINO=$(A_CONFIG_SYSTEM_GAMEBUINO) \
