...
F_CONFIG_BUILD_GEN ?= 1
F_CONFIG_BUILD_ID ?= default
F_CONFIG_BUILD_LIBS ?=
F_CONFIG_BUILD_LUT_GENERATE ?= 0
F_CONFIG_BUILD_MAIN ?= 1
F_CONFIG_BUILD_MAKE := 1
F_CONFIG_BUILD_MAKE_CLEAN ?=
...
ifeq ($(F_CONFIG_PATH_EMBED),)
    F_CONFIG_FILES_EMBED_IN_BIN ?= 0
else
    F_CONFIG_FILES_EMBED_IN_BIN ?= 1
endif
...
F_CONFIG_BUILD_FLAGS_SETTINGS := \
    ...
    -DF_CONFIG_BUILD_FAUR_GIT=\"$(shell cd $(FAUR_PATH) && git rev-parse --verify HEAD)\" \
    -DF_CONFIG_BUILD_FAUR_TIME=\"$(shell date "+%Y-%m-%d\ %H:%M:%S")\" \
    -DF_CONFIG_BUILD_GEN=$(F_CONFIG_BUILD_GEN) \
    -DF_CONFIG_BUILD_LUT_GENERATE=$(F_CONFIG_BUILD_LUT_GENERATE) \
    -DF_CONFIG_BUILD_MAIN=$(F_CONFIG_BUILD_MAIN) \
    -DF_CONFIG_BUILD_MAKE=$(F_CONFIG_BUILD_MAKE) \
    ...
    -DF_CONFIG_FILES_EMBED_IN_BIN=$(F_CONFIG_FILES_EMBED_IN_BIN) \
