...
A_CONFIG_APP_BIN ?= a.out
A_CONFIG_APP_PND ?= $(A_CONFIG_APP_BIN).pnd
A_CONFIG_APP_TITLE ?= Untitled
...
# States
#
#   A_CONFIG_STATE_NUM - Source dir-relative file and enum value to read
#
ifdef A_CONFIG_STATE_NUM
    A_CONFIG_STATE_NUM := $(shell $(A2X_PATH)/bin/a2x_enum -q $(A_CONFIG_DIR_ROOT)/$(A_CONFIG_DIR_SRC)/$(A_CONFIG_STATE_NUM))
endif

A_CONFIG_STATE_NUM ?= 1
...
A_CONFIG_BUILD_CFLAGS += \
    ...
    -DA_CONFIG_APP_TITLE=\"$(A_CONFIG_APP_TITLE)\" \
    ...
    -DA_CONFIG_STATE_NUM=$(A_CONFIG_STATE_NUM) \
