...
static const FColorPixel f__gfx_buffer___palette[10 * 2 * 1] = {
    ...
    #endif
    #if F_CONFIG_SCREEN_FORMAT == F_COLOR_FORMAT_RGBA_5551
    ...
    #endif
    #if F_CONFIG_SCREEN_FORMAT == F_COLOR_FORMAT_ARGB_8888
    ...
    #endif
    #if F_CONFIG_SCREEN_FORMAT == F_COLOR_FORMAT_ABGR_8888
