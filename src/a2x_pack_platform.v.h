...
extern APlatformTexture* a_platform_api__textureNewScreen(const APixels* Pixels);
extern APlatformTexture* a_platform_api__textureNewSprite(const APixels* Pixels);
