...
typedef enum  {
    A_FONT_LOAD_ALL = A_BIT(0),
    A_FONT_LOAD_ALPHANUMERIC = A_BIT(1),
    A_FONT_LOAD_ALPHA = A_BIT(2),
    A_FONT_LOAD_NUMERIC = A_BIT(3),
    A_FONT_LOAD_CAPS = A_BIT(4),
} AFontLoad;

typedef enum {
    A_FONT_ALIGN_LEFT = A_BIT(0),
    A_FONT_ALIGN_MIDDLE = A_BIT(1),
    A_FONT_ALIGN_RIGHT = A_BIT(2),
    A_FONT_ALIGN_MONOSPACED = A_BIT(3),
} AFontAlign;
