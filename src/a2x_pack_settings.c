...
static ASetting g_settings[A_SETTING_NUM] = {
    ...
    A__SETTING(A_SETTING_VIDEO_ZOOM, A__SETTING_TYPE_INT, A__SETTING_FLAG_NONE, integer, A_CONFIG_SCREEN_ZOOM),
    A__SETTING(A_SETTING_VIDEO_VSYNC, A__SETTING_TYPE_BOOL, A__SETTING_FLAG_SET_ONCE, boolean, A_CONFIG_SCREEN_VSYNC),
